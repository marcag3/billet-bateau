...
import { z } from "zod";
import { zOptionalTrimmedEmail } from "../validation/zod-fields";
...
export const bookingTicketsSchema = z.object({
    ...
    email: zOptionalTrimmedEmail('Please enter a valid email address').nullable().default(null),
...
export function createBookingTicketsCollection(
    ...
    const collection = createAppPowerSyncCollection('booking_tickets', {
