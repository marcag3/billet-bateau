export default {
    ...
    ticketTypesList: {
        ...
        priceCentsHint: 'Integer cents (e.g. 2500 = $25.00). Leave empty if not priced.',
        ...
        deleteConfirmMessage: 'Remove "{title}"? This cannot be undone if no booking lines use it.',
        errorGeneric: 'Something went wrong. Please try again.',
        validationTitleRequired: 'Title is required.',
        validationMaxGteMin: 'Maximum must be greater than or equal to minimum.',
        invalidCapsJson: 'Per-trip caps must be valid JSON: an object with sortie ids as keys and non-negative integers or null as values.',
