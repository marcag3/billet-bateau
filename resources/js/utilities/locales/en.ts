export default {
    ...
    publicBooking: {
        ...
        submitting: "Booking…",
        boatTypeFilterTitle: "Filter by boat type",
        boatTypeFilterButton: "Boat type",
        boatTypeFilterModalTitle: "Boat type",
        noBoatTypeFilters: "No boat type filters available.",
        boatTypeFilterSelectPlaceholder: "All boat types",
        boatImagePlaceholder: "Boat image unavailable",
        waterRouteFilterTitle: "Filter by water route",
        waterRouteFilterButton: "Route",
        waterRouteFilterModalTitle: "Route",
        waterRouteFilterSelectPlaceholder: "All routes",
        clearWaterRouteFilter: "Clear route",
        noWaterRouteFilters: "No route filters available.",
        routeTracePlaceholder: "Route trace unavailable",
