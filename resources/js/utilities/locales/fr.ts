export default {
    ...
    publicBooking: {
        ...
        boatTypeFilterTitle: "Filtrer par type de bateau",
        boatTypeFilterButton: "Type de bateau",
        boatTypeFilterModalTitle: "Type de bateau",
        noBoatTypeFilters: "Aucun filtre de type de bateau disponible.",
        boatTypeFilterSelectPlaceholder: "Tous les types de bateau",
        boatImagePlaceholder: "Image du bateau indisponible",
        waterRouteFilterTitle: "Filtrer par parcours",
        waterRouteFilterButton: "Parcours",
        waterRouteFilterModalTitle: "Parcours",
        waterRouteFilterSelectPlaceholder: "Tous les parcours",
        clearWaterRouteFilter: "Effacer le parcours",
        noWaterRouteFilters: "Aucun filtre de parcours disponible.",
        routeTracePlaceholder: "Trace du parcours indisponible",
        ...
        availabilityLegendFull: "Complet (0 % restant)",
        availabilityLegendLow: "Faible (<40 % restant)",
        availabilityLegendGood: "Bon (>=40 % restant)",
        noTripsForFilters: "Aucune sortie ne correspond a ces filtres.",
