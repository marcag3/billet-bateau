...
class BookingReactivationNotification extends Notification
{
    use Queueable;
    ...
    private function buildMailMessage(string $locale): MailMessage
    {
        ...
        $message = (new MailMessage)
            ->subject(__('Réactivation confirmée — :program', ['program' => $programName]))
            ->greeting(__('Bonjour :name,', ['name' => $this->booking->contact_name]))
            ->line(__('Votre réservation pour :program est de nouveau active.', ['program' => $programName]))
